...
Page({
    ...
    onLoad: function(options) {
        ...
        if (options.hasOwnProperty('userTaskId')) {
            self.setData({
        ...
        if(this.data.question){
           wx.navigateTo({
            url:'/pages/taskDetail/webview/webview?userTaskId='+this.data.userTaskId
             ...
             wx.navigateTo({
                url: '/pages/taskDetail/submitTask/submitTask?shareTip=' + this.data.shareText + '&userTaskId=' + this.data.userTaskId + '&submitComment=' + this.data.submitComment
            })
        }
    },
